...
namespace UtilityLibrary.WinControls
{
	...
	public class OutlookBar : System.Windows.Forms.Control
	{
        ...
        public delegate void reGetFriend();
        public event reGetFriend refreshFriends;
		...
		{
			// context menu
			MenuItemEx largeIconsMenu = new MenuItemEx("大图标", new EventHandler(OnContextMenu));
			MenuItemEx smallIconsMenu = new MenuItemEx("小图标", new EventHandler(OnContextMenu));
			MenuItemEx separator1 = new MenuItemEx("-", new EventHandler(OnContextMenu));
			MenuItemEx renameGroup = new MenuItemEx("重命名组", new EventHandler(OnContextMenu));
			MenuItemEx separator2 = new MenuItemEx("-", new EventHandler(OnContextMenu));
            MenuItemEx renameShortcut = new MenuItemEx("重命名", new EventHandler(OnContextMenu));
            renameShortcut.Visible = false;
            MenuItemEx refreshFriends = new MenuItemEx("刷新", new EventHandler(OnContextMenu));
            ...
            contextMenu.MenuItems.Add(6, refreshFriends);
